...
if "%input%"=="-1" (
	...
	>%tempoutput% (
		...
		%simc% input=..\config.simc output=nul target_error=0.05 "$(fight_style)=1t" "$(option_override)=%t_sub_1t%" "$(specialization)=subtlety" "$(tier)=t19m" input=main.simc input=legendaries.simc input=report_html.simc
	...
	>%output% (
		...
		echo "1-Target"
		echo "Rogue Assassination T19M"
		%simc% input=..\config.simc output=nul target_error=0.2 "$(fight_style)=1t" "$(option_override)=%t_asn_1t%" "$(specialization)=assassination" "$(tier)=t19m" input=main.simc input=legendaries.simc input=report_html.simc input=report_json.simc
		echo "Rogue Assassination Exsg T19M"
		%simc% input=..\config.simc output=nul target_error=0.2 "$(fight_style)=1t" "$(option_override)=%t_asn_ex_1t%" "$(specialization)=assassination" "$(specialization_suffix)=_Exsg_" "$(tier)=t19m" input=main.simc "$(spec)=asn_ex" "$(root)=$(clas)_$(spec)_$(tier_suffix)" input=legendaries.simc input=report_html.simc input=report_json.simc
		echo "Rogue Outlaw T19M"
		%simc% input=..\config.simc output=nul target_error=0.2 "$(fight_style)=1t" "$(option_override)=%t_otl_1t%" "$(specialization)=outlaw" "$(tier)=t19m" input=main.simc input=legendaries.simc input=report_html.simc input=report_json.simc
		echo "Rogue Subtlety T19M"
		%simc% input=..\config.simc output=nul target_error=0.2 "$(fight_style)=1t" "$(option_override)=%t_sub_1t%" "$(specialization)=subtlety" "$(tier)=t19m" input=main.simc input=legendaries.simc input=report_html.simc input=report_json.simc

		echo "2-Target"
		echo "Rogue Assassination T19M"
		%simc% input=..\config.simc output=nul target_error=0.2 "$(fight_style)=2t" "$(option_override)=%t_asn_2t%" "$(specialization)=assassination" "$(tier)=t19m" input=main.simc input=legendaries.simc input=report_html.simc input=report_json.simc
		echo "Rogue Assassination Exsg T19M"
		%simc% input=..\config.simc output=nul target_error=0.2 "$(fight_style)=2t" "$(option_override)=%t_asn_ex_2t%" "$(specialization)=assassination" "$(specialization_suffix)=_Exsg_" "$(tier)=t19m" input=main.simc "$(spec)=asn_ex" "$(root)=$(clas)_$(spec)_$(tier_suffix)" input=legendaries.simc input=report_html.simc input=report_json.simc
		echo "Rogue Outlaw T19M"
		%simc% input=..\config.simc output=nul target_error=0.2 "$(fight_style)=2t" "$(option_override)=%t_otl_2t%" "$(specialization)=outlaw" "$(tier)=t19m" input=main.simc input=legendaries.simc input=report_html.simc input=report_json.simc
		echo "Rogue Subtlety T19M"
		%simc% input=..\config.simc output=nul target_error=0.2 "$(fight_style)=2t" "$(option_override)=%t_sub_2t%" "$(specialization)=subtlety" "$(tier)=t19m" input=main.simc input=legendaries.simc input=report_html.simc input=report_json.simc

		echo "3-Target"
		echo "Rogue Assassination T19M"
		%simc% input=..\config.simc output=nul target_error=0.2 "$(fight_style)=3t" "$(option_override)=%t_asn_3t%" "$(specialization)=assassination" "$(tier)=t19m" input=main.simc input=legendaries.simc input=report_html.simc input=report_json.simc
		echo "Rogue Assassination Exsg T19M"
		%simc% input=..\config.simc output=nul target_error=0.2 "$(fight_style)=3t" "$(option_override)=%t_asn_ex_3t%" "$(specialization)=assassination" "$(specialization_suffix)=_Exsg_" "$(tier)=t19m" input=main.simc "$(spec)=asn_ex" "$(root)=$(clas)_$(spec)_$(tier_suffix)" input=legendaries.simc input=report_html.simc input=report_json.simc
		echo "Rogue Outlaw T19M"
		%simc% input=..\config.simc output=nul target_error=0.2 "$(fight_style)=3t" "$(option_override)=%t_otl_3t%" "$(specialization)=outlaw" "$(tier)=t19m" input=main.simc input=legendaries.simc input=report_html.simc input=report_json.simc
		echo "Rogue Subtlety T19M"
		%simc% input=..\config.simc output=nul target_error=0.2 "$(fight_style)=3t" "$(option_override)=%t_sub_3t%" "$(specialization)=subtlety" "$(tier)=t19m" input=main.simc input=legendaries.simc input=report_html.simc input=report_json.simc

		echo "1-Target RE-Adds:4_3x_30_10"
		echo "Rogue Assassination T19M"
		%simc% input=..\config.simc output=nul target_error=0.2 "$(fight_style)=1t" "$(option_override)=%t_asn_1ta%" "$(specialization)=assassination" "$(tier)=t19m" input=main.simc input=legendaries.simc input="$(fight_style_path)"aethys_adds_4_3x_30_10.simc input=report_html.simc input=report_json.simc
		echo "Rogue Assassination Exsg T19M"
		...
		echo "Rogue Outlaw T19M"
		%simc% input=..\config.simc output=nul target_error=0.2 "$(fight_style)=1t" "$(option_override)=%t_otl_1ta%" "$(specialization)=outlaw" "$(tier)=t19m" input=main.simc input=legendaries.simc input="$(fight_style_path)"aethys_adds_4_3x_30_10.simc input=report_html.simc input=report_json.simc
		echo "Rogue Subtlety T19M"
		%simc% input=..\config.simc output=nul target_error=0.2 "$(fight_style)=1t" "$(option_override)=%t_sub_1ta%" "$(specialization)=subtlety" "$(tier)=t19m" input=main.simc input=legendaries.simc input="$(fight_style_path)"aethys_adds_4_3x_30_10.simc input=report_html.simc input=report_json.simc
	)
	@pause
) else if "%input%"=="6" (
	>%output% (
		...
		%simc% input=..\config.simc output=nul target_error=0.2 "$(fight_style)=1t" "$(option_override)=%t_asn_1t%" "$(specialization)=assassination" "$(tier)=t19m" input=main.simc input=legendaries.simc "$(option_override)=%t_asn_ex_1t%" "$(specialization)=assassination" "$(specialization_suffix)=_Exsg_" "$(tier)=t19m" input=main.simc "$(spec)=asn_ex" "$(root)=$(clas)_$(spec)_$(tier_suffix)" input=legendaries.simc "$(option_override)=%t_otl_1t%" "$(specialization)=outlaw" "$(specialization_suffix)=_" "$(tier)=t19m" input=main.simc input=legendaries.simc "$(option_override)=%t_sub_1t%" "$(specialization)=subtlety" "$(tier)=t19m" input=main.simc input=legendaries.simc "$(clas)=discord_rog" "$(spec)=all" input=report_html.simc

		echo "2-Target"
		echo "Rogue Assassination & Outlaw & Subtlety @ T19M"
		%simc% input=..\config.simc output=nul target_error=0.2 "$(fight_style)=2t" "$(option_override)=%t_asn_2t%" "$(specialization)=assassination" "$(tier)=t19m" input=main.simc input=legendaries.simc "$(option_override)=%t_asn_ex_2t%" "$(specialization)=assassination" "$(specialization_suffix)=_Exsg_" "$(tier)=t19m" input=main.simc "$(spec)=asn_ex" "$(root)=$(clas)_$(spec)_$(tier_suffix)" input=legendaries.simc "$(option_override)=%t_otl_2t%" "$(specialization)=outlaw" "$(specialization_suffix)=_" "$(tier)=t19m" input=main.simc input=legendaries.simc "$(option_override)=%t_sub_2t%" "$(specialization)=subtlety" "$(tier)=t19m" input=main.simc input=legendaries.simc "$(clas)=discord_rog" "$(spec)=all" input=report_html.simc

		echo "3-Target"
		echo "Rogue Assassination & Outlaw & Subtlety @ T19M"
		%simc% input=..\config.simc output=nul target_error=0.2 "$(fight_style)=3t" "$(option_override)=%t_asn_3t%" "$(specialization)=assassination" "$(tier)=t19m" input=main.simc input=legendaries.simc "$(option_override)=%t_asn_ex_3t%" "$(specialization)=assassination" "$(specialization_suffix)=_Exsg_" "$(tier)=t19m" input=main.simc "$(spec)=asn_ex" "$(root)=$(clas)_$(spec)_$(tier_suffix)" input=legendaries.simc "$(option_override)=%t_otl_3t%" "$(specialization)=outlaw" "$(specialization_suffix)=_" "$(tier)=t19m" input=main.simc input=legendaries.simc "$(option_override)=%t_sub_3t%" "$(specialization)=subtlety" "$(tier)=t19m" input=main.simc input=legendaries.simc "$(clas)=discord_rog" "$(spec)=all" input=report_html.simc

		echo "1-Target RE-Adds:4_3x_30_10"
		echo "Rogue Assassination & Outlaw & Subtlety @ T19M"
		%simc% input=..\config.simc output=nul target_error=0.2 "$(fight_style)=1t" "$(option_override)=%t_asn_1ta%" "$(specialization)=assassination" "$(tier)=t19m" input=main.simc input=legendaries.simc "$(option_override)=%t_asn_ex_1ta%" "$(specialization)=assassination" "$(specialization_suffix)=_Exsg_" "$(tier)=t19m" input=main.simc "$(spec)=asn_ex" "$(root)=$(clas)_$(spec)_$(tier_suffix)" input=legendaries.simc "$(option_override)=%t_otl_1ta%" "$(specialization)=outlaw" "$(specialization_suffix)=_" "$(tier)=t19m" input=main.simc input=legendaries.simc "$(option_override)=%t_sub_1ta%" "$(specialization)=subtlety" "$(tier)=t19m" input=main.simc input=legendaries.simc input="$(fight_style_path)"aethys_adds_4_3x_30_10.simc "$(clas)=discord_rog" "$(spec)=all" input=report_html.simc
	)
	@pause
) else if "%input%"=="7" (
	>%output% (
