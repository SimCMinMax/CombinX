...
set "t_sub_2t=talents=2210021"
set "t_sub_3t=talents=2210021"
...
if "%input%"=="0" (
	...
	>%output% (
		...
		%simc% input=global.simc output=nul target_error=0.4 "$(fight_style)=1t" "$(specialization)=assassination" "$(specialization_suffix)=_Exsg_" "$(tier)=t19m" input=main.simc "$(spec)=asn_ex" "$(root)=$(clas)_$(spec)_$(tier_suffix)" "$(row)=all" input=talents.simc input=report_json.simc
		...
		echo "Rogue Assassination Exsg T19M"
		%simc% input=global.simc output=nul target_error=0.4 "$(fight_style)=2t" "$(specialization)=assassination" "$(specialization_suffix)=_Exsg_" "$(tier)=t19m" input=main.simc "$(spec)=asn_ex" "$(root)=$(clas)_$(spec)_$(tier_suffix)" "$(row)=all" input=talents.simc input=report_json.simc
		echo "Rogue Outlaw T19M"
		...
		echo "Rogue Assassination Exsg T19M"
		%simc% input=global.simc output=nul target_error=0.4 "$(fight_style)=3t" "$(specialization)=assassination" "$(specialization_suffix)=_Exsg_" "$(tier)=t19m" input=main.simc "$(spec)=asn_ex" "$(root)=$(clas)_$(spec)_$(tier_suffix)" "$(row)=all" input=talents.simc input=report_json.simc
		echo "Rogue Outlaw T19M"
		...
		echo "Rogue Assassination Exsg T19M"
		%simc% input=global.simc output=nul target_error=0.4 "$(fight_style)=1t" "$(specialization)=assassination" "$(specialization_suffix)=_Exsg_" "$(tier)=t19m" input=main.simc input="$(fight_style_path)"aethys_adds_4_3x_30_10.simc "$(spec)=asn_ex" "$(root)=$(clas)_$(spec)_$(tier_suffix)" "$(row)=all" input=talents.simc input=report_json.simc
		echo "Rogue Outlaw T19M"
	...
	>%output% (
		...
		%simc% input=global.simc output=nul target_error=0.1 "$(fight_style)=1t" "$(option_override)=%t_asn_ex_1t%" "$(specialization)=assassination" "$(specialization_suffix)=_Exsg_" "$(tier)=t19p" input=main.simc "$(spec)=asn_ex" "$(root)=$(clas)_$(spec)_$(tier_suffix)" "$(tier)=t19h" input=main.simc "$(spec)=asn_ex" "$(root)=$(clas)_$(spec)_$(tier_suffix)" "$(tier)=t19m" input=main.simc "$(spec)=asn_ex" "$(root)=$(clas)_$(spec)_$(tier_suffix)" "$(tier)=t19x" input=report_html.simc input=report_json.simc
		...
		echo "Rogue Assassination Exsg T19P & T19H & T19M"
		%simc% input=global.simc output=nul target_error=0.1 "$(fight_style)=2t" "$(option_override)=%t_asn_ex_2t%" "$(specialization)=assassination" "$(specialization_suffix)=_Exsg_" "$(tier)=t19p" input=main.simc "$(spec)=asn_ex" "$(root)=$(clas)_$(spec)_$(tier_suffix)" "$(tier)=t19h" input=main.simc "$(spec)=asn_ex" "$(root)=$(clas)_$(spec)_$(tier_suffix)" "$(tier)=t19m" input=main.simc "$(spec)=asn_ex" "$(root)=$(clas)_$(spec)_$(tier_suffix)" "$(tier)=t19x" input=report_html.simc input=report_json.simc
		echo "Rogue Outlaw T19P & T19H & T19M"
		...
		echo "Rogue Assassination Exsg T19P & T19H & T19M"
		%simc% input=global.simc output=nul target_error=0.1 "$(fight_style)=3t" "$(option_override)=%t_asn_ex_3t%" "$(specialization)=assassination" "$(specialization_suffix)=_Exsg_" "$(tier)=t19p" input=main.simc "$(spec)=asn_ex" "$(root)=$(clas)_$(spec)_$(tier_suffix)" "$(tier)=t19h" input=main.simc "$(spec)=asn_ex" "$(root)=$(clas)_$(spec)_$(tier_suffix)" "$(tier)=t19m" input=main.simc "$(spec)=asn_ex" "$(root)=$(clas)_$(spec)_$(tier_suffix)" "$(tier)=t19x" input=report_html.simc input=report_json.simc
		echo "Rogue Outlaw T19P & T19H & T19M"
		...
		echo "Rogue Assassination Exsg T19P & T19H & T19M"
		%simc% input=global.simc output=nul target_error=0.1 "$(fight_style)=1t" "$(option_override)=%t_asn_ex_1ta%" "$(specialization)=assassination" "$(specialization_suffix)=_Exsg_" "$(tier)=t19p" input=main.simc "$(spec)=asn_ex" "$(root)=$(clas)_$(spec)_$(tier_suffix)" "$(tier)=t19h" input=main.simc "$(spec)=asn_ex" "$(root)=$(clas)_$(spec)_$(tier_suffix)" "$(tier)=t19m" input=main.simc "$(spec)=asn_ex" "$(root)=$(clas)_$(spec)_$(tier_suffix)" input="$(fight_style_path)"aethys_adds_4_3x_30_10.simc "$(tier)=t19x" input=report_html.simc input=report_json.simc
		echo "Rogue Outlaw T19P & T19H & T19M"
	...
	>%output% (
		...
		%simc% input=global.simc output=nul target_error=0.1 "$(sim_type)=default_combined" "$(fight_style)=1t" "$(option_override)=%t_asn_1t%" "$(specialization)=assassination" "$(tier)=t19p" input=main.simc "$(tier)=t19h" input=main.simc "$(tier)=t19m" input=main.simc "$(option_override)=%t_asn_ex_1t%" "$(specialization)=assassination" "$(specialization_suffix)=_Exsg_" "$(tier)=t19p" input=main.simc "$(spec)=asn_ex" "$(root)=$(clas)_$(spec)_$(tier_suffix)" input=name_override.simc "$(tier)=t19h" input=main.simc "$(spec)=asn_ex" "$(root)=$(clas)_$(spec)_$(tier_suffix)" input=name_override.simc "$(tier)=t19m" input=main.simc "$(spec)=asn_ex" "$(root)=$(clas)_$(spec)_$(tier_suffix)" input=name_override.simc "$(option_override)=%t_otl_1t%" "$(specialization)=outlaw" "$(specialization_suffix)=_" "$(tier)=t19p" input=main.simc "$(tier)=t19h" input=main.simc "$(tier)=t19m" input=main.simc "$(option_override)=%t_sub_1t%" "$(specialization)=subtlety" "$(tier)=t19p" input=main.simc "$(tier)=t19h" input=main.simc "$(tier)=t19m" input=main.simc "$(clas)=discord_rog" "$(spec)=all" "$(tier)=t19x" input=report_html.simc

		echo "2-Target"
		echo "Rogue Assassination & Outlaw & Subtlety @ T19P & T19H & T19M"
		%simc% input=global.simc output=nul target_error=0.1 "$(sim_type)=default_combined" "$(fight_style)=2t" "$(option_override)=%t_asn_2t%" "$(specialization)=assassination" "$(tier)=t19p" input=main.simc "$(tier)=t19h" input=main.simc "$(tier)=t19m" input=main.simc "$(option_override)=%t_asn_ex_2t%" "$(specialization)=assassination" "$(specialization_suffix)=_Exsg_" "$(tier)=t19p" input=main.simc "$(spec)=asn_ex" "$(root)=$(clas)_$(spec)_$(tier_suffix)" input=name_override.simc "$(tier)=t19h" input=main.simc "$(spec)=asn_ex" "$(root)=$(clas)_$(spec)_$(tier_suffix)" input=name_override.simc "$(tier)=t19m" input=main.simc "$(spec)=asn_ex" "$(root)=$(clas)_$(spec)_$(tier_suffix)" input=name_override.simc "$(option_override)=%t_otl_2t%" "$(specialization)=outlaw" "$(specialization_suffix)=_" "$(tier)=t19p" input=main.simc "$(tier)=t19h" input=main.simc "$(tier)=t19m" input=main.simc "$(option_override)=%t_sub_2t%" "$(specialization)=subtlety" "$(tier)=t19p" input=main.simc "$(tier)=t19h" input=main.simc "$(tier)=t19m" input=main.simc "$(clas)=discord_rog" "$(spec)=all" "$(tier)=t19x" input=report_html.simc

		echo "3-Target"
		echo "Rogue Assassination & Outlaw & Subtlety @ T19P & T19H & T19M"
		%simc% input=global.simc output=nul target_error=0.1 "$(sim_type)=default_combined" "$(fight_style)=3t" "$(option_override)=%t_asn_3t%" "$(specialization)=assassination" "$(tier)=t19p" input=main.simc "$(tier)=t19h" input=main.simc "$(tier)=t19m" input=main.simc "$(option_override)=%t_asn_ex_3t%" "$(specialization)=assassination" "$(specialization_suffix)=_Exsg_" "$(tier)=t19p" input=main.simc "$(spec)=asn_ex" "$(root)=$(clas)_$(spec)_$(tier_suffix)" input=name_override.simc "$(tier)=t19h" input=main.simc "$(spec)=asn_ex" "$(root)=$(clas)_$(spec)_$(tier_suffix)" input=name_override.simc "$(tier)=t19m" input=main.simc "$(spec)=asn_ex" "$(root)=$(clas)_$(spec)_$(tier_suffix)" input=name_override.simc "$(option_override)=%t_otl_3t%" "$(specialization)=outlaw" "$(specialization_suffix)=_" "$(tier)=t19p" input=main.simc "$(tier)=t19h" input=main.simc "$(tier)=t19m" input=main.simc "$(option_override)=%t_sub_3t%" "$(specialization)=subtlety" "$(tier)=t19p" input=main.simc "$(tier)=t19h" input=main.simc "$(tier)=t19m" input=main.simc "$(clas)=discord_rog" "$(spec)=all" "$(tier)=t19x" input=report_html.simc

		echo "1-Target"
		echo "Rogue Assassination & Outlaw & Subtlety @ T19P & T19H & T19M"
		%simc% input=global.simc output=nul target_error=0.1 "$(sim_type)=default_combined" "$(fight_style)=1t" "$(option_override)=%t_asn_1ta%" "$(specialization)=assassination" "$(tier)=t19p" input=main.simc "$(tier)=t19h" input=main.simc "$(tier)=t19m" input=main.simc "$(option_override)=%t_asn_ex_1ta%" "$(specialization)=assassination" "$(specialization_suffix)=_Exsg_" "$(tier)=t19p" input=main.simc "$(spec)=asn_ex" "$(root)=$(clas)_$(spec)_$(tier_suffix)" input=name_override.simc "$(tier)=t19h" input=main.simc "$(spec)=asn_ex" "$(root)=$(clas)_$(spec)_$(tier_suffix)" input=name_override.simc "$(tier)=t19m" input=main.simc "$(spec)=asn_ex" "$(root)=$(clas)_$(spec)_$(tier_suffix)" input=name_override.simc "$(option_override)=%t_otl_1ta%" "$(specialization)=outlaw" "$(specialization_suffix)=_" "$(tier)=t19p" input=main.simc "$(tier)=t19h" input=main.simc "$(tier)=t19m" input=main.simc "$(option_override)=%t_sub_1ta%" "$(specialization)=subtlety" "$(tier)=t19p" input=main.simc "$(tier)=t19h" input=main.simc "$(tier)=t19m" input=main.simc input="$(fight_style_path)"aethys_adds_4_3x_30_10.simc "$(clas)=discord_rog" "$(spec)=all" "$(tier)=t19x" input=report_html.simc
	)
	@pause
) else if "%input%"=="5" (
	>%output% (
	...
	>%output% (
		...
		echo "Rogue Assassination Exsg T19M"
		%simc% input=global.simc output=nul target_error=0.2 "$(fight_style)=1t" "$(option_override)=%t_asn_ex_1t%" "$(specialization)=assassination" "$(specialization_suffix)=_Exsg_" "$(tier)=t19m" input=main.simc "$(spec)=asn_ex" "$(root)=$(clas)_$(spec)_$(tier_suffix)" input=races.simc input=report_html.simc input=report_json.simc
		echo "Rogue Outlaw T19M"
		...
		echo "Rogue Assassination Exsg T19M"
		%simc% input=global.simc output=nul target_error=0.2 "$(fight_style)=2t" "$(option_override)=%t_asn_ex_2t%" "$(specialization)=assassination" "$(specialization_suffix)=_Exsg_" "$(tier)=t19m" input=main.simc "$(spec)=asn_ex" "$(root)=$(clas)_$(spec)_$(tier_suffix)" input=races.simc input=report_html.simc input=report_json.simc
		echo "Rogue Outlaw T19M"
		...
		echo "Rogue Assassination Exsg T19M"
		%simc% input=global.simc output=nul target_error=0.2 "$(fight_style)=3t" "$(option_override)=%t_asn_ex_3t%" "$(specialization)=assassination" "$(specialization_suffix)=_Exsg_" "$(tier)=t19m" input=main.simc "$(spec)=asn_ex" "$(root)=$(clas)_$(spec)_$(tier_suffix)" input=races.simc input=report_html.simc input=report_json.simc
		echo "Rogue Outlaw T19M"
	...
	>%output% (
		...
		echo "Rogue Assassination Exsg T19M"
		%simc% input=global.simc output=nul target_error=0.2 "$(fight_style)=1t" "$(option_override)=%t_asn_ex_1t%" "$(specialization)=assassination" "$(specialization_suffix)=_Exsg_" "$(tier)=t19m" input=main.simc "$(spec)=asn_ex" "$(root)=$(clas)_$(spec)_$(tier_suffix)" input=trinkets.simc input=report_html.simc input=report_json.simc
		echo "Rogue Outlaw T19M"
		...
		echo "Rogue Assassination Exsg T19M"
		%simc% input=global.simc output=nul target_error=0.2 "$(fight_style)=2t" "$(option_override)=%t_asn_ex_2t%" "$(specialization)=assassination" "$(specialization_suffix)=_Exsg_" "$(tier)=t19m" input=main.simc "$(spec)=asn_ex" "$(root)=$(clas)_$(spec)_$(tier_suffix)" input=trinkets.simc input=report_html.simc input=report_json.simc
		echo "Rogue Outlaw T19M"
		...
		echo "Rogue Assassination Exsg T19M"
		%simc% input=global.simc output=nul target_error=0.2 "$(fight_style)=3t" "$(option_override)=%t_asn_ex_3t%" "$(specialization)=assassination" "$(specialization_suffix)=_Exsg_" "$(tier)=t19m" input=main.simc "$(spec)=asn_ex" "$(root)=$(clas)_$(spec)_$(tier_suffix)" input=trinkets.simc input=report_html.simc input=report_json.simc
		echo "Rogue Outlaw T19M"
	...
	>%output% (
		...
		echo "1-Target"
		echo "Rogue Assassination T19M"
		%simc% input=global.simc output=nul target_error=0.2 "$(fight_style)=1t" "$(option_override)=%t_asn_1t%" "$(specialization)=assassination" "$(tier)=t19m" input=main.simc input=relics.simc input=report_html.simc input=report_json.simc
		echo "Rogue Assassination Exsg T19M"
		%simc% input=global.simc output=nul target_error=0.2 "$(fight_style)=1t" "$(option_override)=%t_asn_ex_1t%" "$(specialization)=assassination" "$(specialization_suffix)=_Exsg_" "$(tier)=t19m" input=main.simc "$(spec)=asn_ex" "$(root)=$(clas)_$(spec)_$(tier_suffix)" input=relics.simc input=report_html.simc input=report_json.simc
		echo "Rogue Outlaw T19M"
		...
		echo "Rogue Subtlety T19M"
		%simc% input=global.simc output=nul target_error=0.2 "$(fight_style)=1t" "$(option_override)=%t_sub_1t%" "$(specialization)=subtlety" "$(tier)=t19m" input=main.simc input=relics.simc input=report_html.simc input=report_json.simc

		echo "2-Target"
		echo "Rogue Assassination T19M"
		%simc% input=global.simc output=nul target_error=0.2 "$(fight_style)=2t" "$(option_override)=%t_asn_2t%" "$(specialization)=assassination" "$(tier)=t19m" input=main.simc input=relics.simc input=report_html.simc input=report_json.simc
		echo "Rogue Assassination Exsg T19M"
		%simc% input=global.simc output=nul target_error=0.2 "$(fight_style)=2t" "$(option_override)=%t_asn_ex_2t%" "$(specialization)=assassination" "$(specialization_suffix)=_Exsg_" "$(tier)=t19m" input=main.simc "$(spec)=asn_ex" "$(root)=$(clas)_$(spec)_$(tier_suffix)" input=relics.simc input=report_html.simc input=report_json.simc
		echo "Rogue Outlaw T19M"
		...
		echo "Rogue Subtlety T19M"
		%simc% input=global.simc output=nul target_error=0.2 "$(fight_style)=2t" "$(option_override)=%t_sub_2t%" "$(specialization)=subtlety" "$(tier)=t19m" input=main.simc input=relics.simc input=report_html.simc input=report_json.simc

		echo "3-Target"
		echo "Rogue Assassination T19M"
		%simc% input=global.simc output=nul target_error=0.2 "$(fight_style)=3t" "$(option_override)=%t_asn_3t%" "$(specialization)=assassination" "$(tier)=t19m" input=main.simc input=relics.simc input=report_html.simc input=report_json.simc
		echo "Rogue Assassination Exsg T19M"
		%simc% input=global.simc output=nul target_error=0.2 "$(fight_style)=3t" "$(option_override)=%t_asn_ex_3t%" "$(specialization)=assassination" "$(specialization_suffix)=_Exsg_" "$(tier)=t19m" input=main.simc "$(spec)=asn_ex" "$(root)=$(clas)_$(spec)_$(tier_suffix)" input=relics.simc input=report_html.simc input=report_json.simc
		echo "Rogue Outlaw T19M"
		...
		echo "Rogue Subtlety T19M"
		%simc% input=global.simc output=nul target_error=0.2 "$(fight_style)=3t" "$(option_override)=%t_sub_3t%" "$(specialization)=subtlety" "$(tier)=t19m" input=main.simc input=relics.simc input=report_html.simc input=report_json.simc

		echo "1-Target RE-Adds:4_3x_30_10"
		echo "Rogue Assassination T19M"
		%simc% input=global.simc output=nul target_error=0.2 "$(fight_style)=1t" "$(option_override)=%t_asn_1ta%" "$(specialization)=assassination" "$(tier)=t19m" input=main.simc input=relics.simc input="$(fight_style_path)"aethys_adds_4_3x_30_10.simc input=report_html.simc input=report_json.simc
		echo "Rogue Assassination Exsg T19M"
		...
		echo "Rogue Subtlety T19M"
		%simc% input=global.simc output=nul target_error=0.2 "$(fight_style)=1t" "$(option_override)=%t_sub_1ta%" "$(specialization)=subtlety" "$(tier)=t19m" input=main.simc input=relics.simc input="$(fight_style_path)"aethys_adds_4_3x_30_10.simc input=report_html.simc input=report_json.simc
	)
	@pause
) else if "%input%"=="11" (
	>%output% (
		...
		%simc% input=global.simc threads=5 output=nul target_error=0.8 "$(fight_style)=1t" "$(option_override)=%t_asn_1t%" "$(specialization)=assassination" "$(tier)=t19m" input=main.simc input=rogue_t19m_plot_21kstats_by1066.simc input=report_json.simc
		echo "Rogue Assassination Exsg T19M 21k"
		%simc% input=global.simc threads=5 output=nul target_error=0.8 "$(fight_style)=1t" "$(option_override)=%t_asn_ex_1t%" "$(specialization)=assassination" "$(specialization_suffix)=_Exsg_" "$(tier)=t19m" input=main.simc "$(spec)=asn_ex" "$(root)=$(clas)_$(spec)_$(tier_suffix)" input=rogue_t19m_plot_21kstats_by1066.simc input=report_json.simc
		echo "Rogue Outlaw T19M 21k"
		%simc% input=global.simc threads=5 output=nul target_error=0.8 "$(fight_style)=1t" "$(option_override)=%t_otl_1t%" "$(specialization)=outlaw" "$(tier)=t19m" input=main.simc input=rogue_t19m_plot_21kstats_by1066.simc input=report_json.simc
		echo "Rogue Subtlety T19M 21k"
		%simc% input=global.simc threads=5 output=nul target_error=0.8 "$(fight_style)=1t" "$(option_override)=%t_sub_1t%" "$(specialization)=subtlety" "$(tier)=t19m" input=main.simc input=rogue_t19m_plot_21kstats_by1066.simc input=report_json.simc

		echo "2-Target"
		echo "Rogue Assassination T19M 21k"
		%simc% input=global.simc threads=5 output=nul target_error=0.8 "$(fight_style)=2t" "$(option_override)=%t_asn_2t%" "$(specialization)=assassination" "$(tier)=t19m" input=main.simc input=rogue_t19m_plot_21kstats_by1066.simc input=report_json.simc
		echo "Rogue Assassination Exsg T19M 21k"
		%simc% input=global.simc threads=5 output=nul target_error=0.8 "$(fight_style)=2t" "$(option_override)=%t_asn_ex_2t%" "$(specialization)=assassination" "$(specialization_suffix)=_Exsg_" "$(tier)=t19m" input=main.simc "$(spec)=asn_ex" "$(root)=$(clas)_$(spec)_$(tier_suffix)" input=rogue_t19m_plot_21kstats_by1066.simc input=report_json.simc
		echo "Rogue Outlaw T19M 21k"
